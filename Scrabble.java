...
public class Scrabble {
	...
	public static String createHand() {
		int lengthH= HAND_SIZE - 2;
        String str1 = MyString.randomStringOfLetters(lengthH);
        String str2 = MyString.insertRandomly('a', str1);
        String str3 = MyString.insertRandomly('e', str2);
        return str3;
	}
	...
	public static void playHand(String hand) {
        ...
        if (newHand.length() == 0) {
            System.out.println("Run out of letters. Total score: " + score + " points");
        } else {
